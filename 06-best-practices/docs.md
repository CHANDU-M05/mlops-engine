...
We have already covered Terraform concepts at a deeper level in the [Data Engineering Zoomcamp](https://github.com/CHANDU-M05/data-engineering-mlops-handbook), and will not be repeating some of those basic concepts again. You can find the content here for your reference:

**Notes**:
* [Terraform Overview](https://github.com/CHANDU-M05/data-engineering-mlops-handbook/blob/main/01-docker-terraform/1_terraform_gcp/1_terraform_overview.md)
...
* [Local Setup for Terraform and GCP](https://github.com/CHANDU-M05/data-engineering-mlops-handbook/tree/main/01-docker-terraform/1_terraform_gcp)
* [GCP Overview](https://github.com/CHANDU-M05/data-engineering-mlops-handbook/blob/main/01-docker-terraform/1_terraform_gcp/2_gcp_overview.md)
* [main.tf](https://github.com/CHANDU-M05/data-engineering-mlops-handbook/blob/main/01-docker-terraform/1_terraform_gcp/terraform/terraform_basic/main.tf)
