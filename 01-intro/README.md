...
* [Local MacOS envprep by Adetbekov](https://github.com/adetbekov/mlops-handbook/blob/main/01-intro/macos-local-envprep.md)
...
* [Useful links by Zioalex](https://github.com/zioalex/mlops-handbook/blob/main/My_notes_week1.md)
* [Notes by Alvaro Navas](https://github.com/ziritrion/mlopsmlops-handbook/blob/main/notes/1_intro.md)
...
* [Cloud server setup using Deploifai (on AWS, Azure, or GCP) by 98sean98](https://github.com/98sean98/mlops-handbook/blob/main/01-intro/deploifai-server/readme.md)
...
* [What is MLOps? - Storytime by Pathik Ghugare](https://github.com/pathikg/MLOps-Zoomcamp-CHANDU-M05/blob/main/week-01-introduction/MLOps-Introduction.md)
...
* [Module 1 Notes -Video 1.2 Env Prep Ec2 troubleshooting notes for remote-ssh vscode to ec2](https://github.com/thatwonguy/mlops-handbook/blob/personal/01-intro/README.md)
* [Ch1 notes by Marcus](https://github.com/mleiwe/mlops-handbook/blob/Ch1_Marcus/cohorts/2024/01-intro/Ch1_Notes.md)
* [GCP setup instructions](https://github.com/mleiwe/mlops-handbook/blob/Ch1_Marcus/cohorts/2024/01-intro/GoogleCloudSetUpNotes.md)
* [Machine Learning Essentials: FAQs on Linear Regression, One-Hot Encoding & RMSE](https://github.com/niting9881/course-mlops-handbook/blob/main/01-intro/README.md)
* [GCP Environment Setup with Terraform + Cloud-Init by Artem](https://github.com/Ladn0/mlops-handbook/tree/main/01-intro/notes)
* [Week 1 - local setup hints by hannarud](https://github.com/hannarud/mlops-handbook-2025/blob/main/week1_notes.md)
* [Week-1 - Introduction to MLOps, Env Setup,Notebooks detailed Notes by Muhammad Shifa](https://github.com/MuhammadShifa/mlops-handbook2025/tree/main/01-introduction#readme)
